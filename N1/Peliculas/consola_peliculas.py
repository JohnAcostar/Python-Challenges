...
def ejecutar_encontrar_pelicula_mas_larga(p1: dict, p2: dict, p3: dict, p4: dict, p5: dict)->None:
    ...
    x = (mod.encontrar_pelicula_mas_larga(p1, p2, p3, p4, p5))
    print(x)
    print ("\n"+"La película más larga es "+ x['nombre']+" con "+str(x['duracion'])+" minutos de duracion"+"\n")
...
def ejecutar_consultar_duracion_promedio_peliculas(p1: dict, p2: dict, p3: dict, p4: dict, p5: dict)->None:
    ...
    Parametros:
        ...
        p5 (dict): Diccionario que contiene la informacion de la pelicula 5.
    """
    x = (mod.duracion_promedio_peliculas(p1, p2, p3, p4, p5))
    print("\n"+ "La duracion promedio de las peliculas en horas y minutos es igual a "+ x + "\n")
...
def ejecutar_encontrar_estrenos(p1: dict, p2: dict, p3: dict, p4: dict, p5: dict)->None:
    ...
    Parametros:
        ...
        p5 (dict): Diccionario que contiene la informacion de la pelicula 5.
    """
    anio = int(input("Ingrese el Año limite para considerar la pelicula como estreno: "))
    
    x = (mod.encontrar_estrenos(p1, p2, p3, p4, p5, anio))
    
    print("Las peliculas estrenadas en una fecha posterior a esta son: "+ x +"\n")
...
def ejecutar_cuantas_peliculas_18_mas(p1: dict, p2: dict, p3: dict, p4: dict, p5: dict)->None:
    ...
    Parametros:
        ...
        p5 (dict): Diccionario que contiene la informacion de la pelicula 5.
    """
    x = (mod.cuantas_peliculas_18_mas(p1, p2, p3, p4, p5))
    print("El numero de peliculas 18+ es: "+ str(x)+ "\n")
...
def ejecutar_reagendar_pelicula(p1: dict, p2: dict, p3: dict, p4: dict, p5: dict)->None:
    ...
    nueva_hora = int(input("Ingrese la hora que quiere verlo: "))
    nuevo_dia = (input("Ingrese el nuevo dia que quiere verlo: "))
    control_horario = (input("Desea que tenga en cuenta sus preferencias sobre el horario para verla? (digite S para si, N para no): " + "\n"))
    if control_horario == "S":
        control_horario = True
    elif control_horario == "N":
...
def ejecutar_decidir_invitar(p1: dict, p2: dict, p3: dict, p4: dict, p5: dict)->None:
    ...
    autorizacion_padres = int(input("Indica si el invitado cuenta con la autorizacion de sus padres con 1 o 0 si no cuenta autorización: "+ "\n"))
    if autorizacion_padres == 1:
        autorizacion_padres = True
    elif autorizacion_padres == 0:
        autorizacion_padres = False
    else:
        print("Ingrese una opcion correcta")
    
    y = (mod.decidir_invitar(pelicula, edad_invitado, autorizacion_padres))
...
def iniciar_aplicacion():
    ...
    print(pelicula1,pelicula2,pelicula3,pelicula4,pelicula5)
